...
local VIEWS: any = {
    ["chicago.shell.sdk:render"] = sdk_render,
    ["chicago.shell.viewers:picture_render"] = picture_render,
}
...
-- `chicago.shell.theme:placements` (subtract, the layers, the crop id and
