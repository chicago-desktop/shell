...
function scene.state(options: any?): any
    ...
    return {
        ...
        items = {{id = "computer", kind = "shortcut", entry = "chicago.shell.explorer:window",
        ...
        widgets = {
            ...
            widget("g2", {entry = "app.monitor:memory", title = "Memory", opens = "chicago.shell.sysprops:window",
                w = 20, h = 8},
                gadget.stack{
