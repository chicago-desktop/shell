...
local function define_tests()
    test.describe("butschster.windows.sdk Small Icons", function()
    ...
    test.describe("butschster.windows.sdk multi-selection", function()
    ...
    test.describe("butschster.windows.sdk tree pointer", function()
    ...
    test.describe("butschster.windows.sdk table cell pictures", function()
