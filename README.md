...
вверх до целых строк терминала: при ячейке в 20 px и выше это ОДНА строка, и
строка меню окна ложится прямо под полосу; при ячейке от 10 до 19 px — две,
и остаток имеет цвет клиента. Полоса в 20 px с рамкой брала две строки при
...
рамка 9×9, крест 8×7. «Свернуть» и «развернуть» стоят вплотную, «закрыть» —
