...
| Вертикальная надпись «Windows 95» | в пикселях — повёрнутая строка; в ячейках — по букве на строку, и на короткой панели видна только часть слова | в ячейках буква занимает клетку, и длина надписи упирается в число пунктов меню. Раньше она при этом пропадала МОЛЧА; теперь обрезается видимо |
